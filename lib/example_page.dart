                    ...
                    Row(
                      ...
                      children: [
                        ...
                        DropdownButton<int>(
                          ...
                          items: generateSectorList(listInformation[0]).map((
                            int value,
                          ) {
                    ...
                    Row(
                      ...
                      children: [
                        TextButton(
                          ...
                          onPressed: () async {
                            final message =
                                await NfcClassicMifarePlus.readBlock(
                        ...
                        TextButton(
                          ...
                          onPressed: () async {
                            final message =
                                await NfcClassicMifarePlus.readSector(
                        ...
                        TextButton(
                          ...
                          onPressed: () async {
                            _cardSectorsInfo =
                                await NfcClassicMifarePlus.readAll();
                            setState(() {});
                          },
                          child: Text('Read All'),
                        ),
                      ...
                      children: [
                        TextButton(
                          ...
                          onPressed: () async => showToast(
                            message: (await NfcClassicMifarePlus.blockCount)
                                .toString(),
                          ),
                        ...
                        TextButton(
                          ...
                          onPressed: () async => showToast(
                            message: (await NfcClassicMifarePlus.sectorCount)
                                .toString(),
                          ),
                    ...
                    TextButton(
                      ...
                      onPressed: () async {
                        ...
                        if (_selectedSector == 0 ||
                          ...
                          await NfcClassicMifarePlus.writeBlock(
                            blockIndex: _selectedBlock,
                            message: message,
                          );
                        }
                    ...
                    TextButton(
                      ...
                      onPressed: () async {
                        ...
                        if (message.isEmpty) {
                          ...
                          await NfcClassicMifarePlus.writeRawHexToBlock(
                            blockIndex: _selectedBlock,
                            message: message,
                          );
                        }
                    ...
                    TextButton(
                      ...
                      onPressed: () async {
                        ...
                        if (message.isEmpty) {
                          ...
                          await NfcClassicMifarePlus.changePasswordOfSector(
                            sectorIndex: 1,
